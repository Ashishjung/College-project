...
function myfunction(){
    if(document.body.scrollTop>0){
        navlink[0].style.transition="all linear 1s";
        navlink[0].style.color="#fc3c3c"
        navlink[1].style.color="black";
        navlink[2].style.color="black";
        navlink[3].style.color="black";
 }
    if(document.body.scrollTop>600){
        navlink[1].style.transition="all linear 1s";
        navlink[1].style.color="#fc3c3c";
        navlink[0].style.color="black";
        navlink[2].style.color="black";
        navlink[3].style.color="black";
}
if(document.body.scrollTop>2100){
    navlink[2].style.transition="all linear 1s";
    navlink[1].style.color="black";
    navlink[2].style.color="#fc3c3c";
    navlink[3].style.color="black";
    navlink[0].style.color="black";
}
if(document.body.scrollTop>4000){
    navlink[3].style.transition="all linear 1s";
    navlink[1].style.color="black";
    navlink[3].style.color="#fc3c3c";
    navlink[2].style.color="black";
    navlink[0].style.color="black";
}
}
